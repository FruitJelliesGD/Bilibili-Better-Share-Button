    ...
    function cleanTitle(ignoredTitle, isLive) {
        ...
        try {
            ...
            if (isLive || window.location.hostname === 'live.bilibili.com') {
                ...
                const titleXPath = '//*[@id="app"]/div/div[3]/div[1]/div[1]/h1/text()';
                const authorXPath = '//*[@id="app"]/div/div[3]/div[1]/div[2]/div[1]/div[2]/div[1]/a';
                ...
                try {
                    ...
                    titleText = titleResult.stringValue.trim();
                    ...
                    console.error('read 页面 XPath 解析失败:', e);
                    titleText = '';
                    authorText = '';
                }
